...
def input_filename():
    ...
    'example.csv'
    '''
    name=input(PROMPT)#create a variable to store the value of user's input
    filename=name+".csv"#then create another variable to store the value of the combination of the user's input and .csv as the filename
    return filename#return the value of filename
